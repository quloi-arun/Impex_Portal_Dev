...
CREATE PROCEDURE USP_GetMappingSubMenuFunctionDetail
AS
BEGIN
SELECT LMF.SubMenu_FunctionId,LMF.SubMenuId,SM.SubMenuName, LMF.FunctionId,FM.FunctionName,MM.MenuId,MM.MenuName,MM.ProjectId,PM.ProjectName
