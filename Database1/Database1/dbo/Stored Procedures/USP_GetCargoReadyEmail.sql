...
CREATE PROCEDURE [dbo].[USP_GetCargoReadyEmail] @POID INT, @SupplierInvoiceDocumentsID INT
AS  
BEGIN
...
<html>
									...
									<table role="presentation" border="0" cellpadding="0" cellspacing="0" style=" border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"width="100%" >
										<tr>
											<td style=" font-family: sans-serif; font-size: 14px; vertical-align: top;"valign="top" >
												...
												<p style=" font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 6px;">' + M.PONumber + ' is ready to depart from Supplier’s facility. Please be ready for GRN. </p>
												...
												<table style="border-collapse: collapse; width: 100%">
													<thead style="background-color: #eff4ff !important">
														...
														<th style="border: 1px solid #dddddd; text-align: left; padding: 8px; color: #3366ff;">Cargo Ready Date</th>
													</thead>
													<tbody>
														<tr>
   ...
   ,(Select Top 1 SubSupplierName From SupplierName Where SupplierName = Trim(M.Supplier))+' - '+M.PONumber +'/'+SUBSTRING(DATENAME(MONTH,PODATE),1,3)+SUBSTRING(DATENAME(YEAR,PODATE),3,4)+ ' is ready.' [Subject]
FROM (
SELECT
		PO.PONumber
	   ,CO.CommentInfo
	...
	CROSS APPLY (SELECT DISTINCT 
			STUFF((SELECT
				...
				<td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">', FORMAT(SID.CargoReadyDate, 'dd-MM-yy'), '</td>
			  </tr>')
