...
CREATE Procedure [dbo].[USP_GetRoleMenuSubMenuFunctionToUserMappingList]
(
@LoginId varchar(90) 
)
As
...
MM.MenuId, MM.MenuName,MM.MenuOrder,MM.MenuIcon,   FM.FunctionId as FunctionId_Menu, (Coalesce(SRM.IsAssigneMenuFunction,0))as IsAssigneMenuFunction , 
