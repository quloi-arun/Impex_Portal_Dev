...
CREATE PROCEDURE [dbo].[USP_GetInvoiceCreatedEmail_20230320] @POID INT, @InvoiceNo VARCHAR(50)
AS  
BEGIN
...
<html>
   ...
   ,M.PONumber+'/'+left(DAtename(Month,M.PODate),3)+''+Right(Year(M.PODate),2)+' - '+Replace(M.Supplier,',','')+' Invoice has been generated.' [Subject]
FROM (
SELECT
		PO.PONumber
	   ,CO.CommentInfo
