CREATE PROCEDURE [dbo].[USP_getUserWiseNotificationCount] @UserId INT
AS
BEGIN
...
WHERE M.isRead=0 AND ((M.UserType='ImpexOperationAdmin' AND M.TODO IN ('NO','NSNT')) OR (M.UserType<>'ImpexOperationAdmin' AND M.TODO IN ('NS','NSNT')))
