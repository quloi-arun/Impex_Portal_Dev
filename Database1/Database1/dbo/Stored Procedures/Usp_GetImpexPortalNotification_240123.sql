CREATE PROCEDURE [dbo].[Usp_GetImpexPortalNotification_240123](@UserID INT)
AS
BEGIN
...
SELECT TOP 100 M.ID,M.ModuleName,M.Header,M.Description,M.Action,M.isRead,RID.RedirectId,M.CreatedDate,M.Status FROM (
...
WHEN Description LIKE 'Order Changed%' THEN 'TO'
WHEN Description LIKE 'PO Changed%' THEN 'TO'
