...
CREATE PROCEDURE [dbo].[USP_GetCargoReadyEmail_20230320] @POID INT, @SupplierInvoiceDocumentsID INT
AS  
BEGIN
...
<html>
   ...
   ,M.PONumber +'/'+left(DAtename(Month,M.PODate),3)+''+Right(Year(M.PODate),2)+' - '+M.Supplier+ ' is ready.' [Subject]
FROM (
SELECT
		PO.PONumber
	   ,CO.CommentInfo
