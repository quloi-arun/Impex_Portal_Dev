...
CREATE PROCEDURE [dbo].[usp_PODashboard_20230206](@fromdate date,@todate date,@SupplierId INT = NULL)    
AS   
BEGIN  
...
GROUP BY FORMAT(Podate, 'MMMM'),FORMAT(Podate, 'MM'),FORMAT(Podate, 'yyyy') )M
